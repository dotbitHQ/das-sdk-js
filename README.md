...
Please set up a [das-account-indexer](https://github.com/dotbitHQ/das-account-indexer) on your own server and keep it running.
...
- `url` is the JSON-RPC endpoint of [das-account-indexer](https://github.com/dotbitHQ/das-account-indexer).
...
> For more information, please see [get-reverse-record-info](https://github.com/dotbitHQ/das-account-indexer/blob/main/API.md#get-reverse-record-info)
...
> All the supported keys can be found here: [record_key_namespace](https://github.com/dotbitHQ/das-contracts/blob/4fdc1e09e484304d25c5965218a52bf9bf7bb7ce/tests/data/record_key_namespace.txt)
> 
